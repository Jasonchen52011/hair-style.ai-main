...
export const metadata: Metadata = {
    ...
    description: 'Free hairstyle AI changer,discover your perfect look! Choose from over 60+ hairstyles, including bob, wavy curls, buzz cut, bald, slicked back, braids, and more',
    alternates: {
