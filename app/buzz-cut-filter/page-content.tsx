                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center">
                            ...
                            <div className="flex justify-center lg:justify-end">
                                <div className="w-full max-w-xl bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                                    <div style={{ width: '100%', height: IMAGE_DISPLAY_HEIGHT, position: 'relative' }}>
                                         <ReactBeforeSliderComponent
                                            firstImage={{
                                                imageUrl: before,
                                                alt: "Before buzz cut - original hairstyle"
                                            }}
                                            secondImage={{
                                                imageUrl: after,
                                                alt: "After buzz cut - transformed hairstyle with short buzz cut"
                                            }}
