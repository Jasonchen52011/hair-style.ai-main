...
import HairTypeIdentifierTool from './content-page'
...
// Hair Type Identifier Page metadata
...
export default function HairTypeIdentifierPage() {
  return (
        <>        
            <script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify({
                    ...structuredData,
                    "@id": "https://hair-style.ai/hair-type-identifier#webapplication",
            ...
            <div className="min-h-screen bg-white flex flex-col">
                ...
                {/* Hair Type Identifier Tool */}
                <HairTypeIdentifierTool />
