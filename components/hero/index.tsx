...
export default function Hero() {
  ...
  const [isAutoScrolling, setIsAutoScrolling] = useState(false); // 默认禁用自动滚动
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Yes, our AI Hairstyle Changer are completely free to use. You can upload your image, try on AI virtual hairstyles, and experiment with different colors without any cost and no sign-up needed.",
    },
    {
  ...
  // Data update function - 优化为懒加载
  const updateDisplayData = (tabType: TabType) => {
    // 使用 requestAnimationFrame 来延迟数据更新，避免阻塞首次渲染
    requestAnimationFrame(() => {
      if (tabType === "Color") {
        ...
        // For hairstyle tabs, set limited data first for faster loading
  ...
  useEffect(() => {
    setMounted(true);
    // Delay data loading to improve initial render
  ...
  // Simplified auto scroll - disabled by default to improve performance
  useEffect(() => {
    ...
    // Significantly delay auto scroll to not interfere with initial load
    const timer = setTimeout(() => {
      ...
      }, 5000); // Much slower auto scroll

      return () => clearInterval(autoScroll);
    }, 5000); // Wait 5 seconds before starting auto scroll
        ...
        <div className="container mx-auto px-4 py-4 md:py-8 mb-6 md:mb-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center max-w-6xl mx-auto">
            <div className="flex justify-center lg:order-2">
              <div className="w-full max-w-sm lg:max-w-lg mx-auto aspect-[4/3] bg-gray-200 rounded-lg animate-pulse"></div>
            </div>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <p className="text-base sm:text-lg text-gray-800 text-center mb-12">
          Transform your hairstyle look with our AI hairstyle changer in just
          three simple steps. Upload your photo, choose from our diverse
          collection of hairstyles, and instantly see yourself with a new look!
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-full mx-auto mb-12">
          ...
          <div className="text-center">
            <Link href="/ai-hairstyle" className="block group">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative bg-white rounded-2xl shadow-lg p-12">
              {/* 引号装饰 */}
              <div
                className="absolute top-8 left-8 text-gray-200"
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-4">
                  <Image
                    src={`/images/reviewer/${testimonials[
                      currentTestimonial
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-4xl font-bold text-gray-800">
                FAQs of Test Hairstyle On Face
              </h2>
            </div>
                ...
                {faqItems
                  ...
                  .map((item, index) => (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`px-6 pb-6 transform transition-all duration-300 ease-in-out ${
                            expandedFAQs.has(index)
