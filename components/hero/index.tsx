...
export default function Hero() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Yes, our AI Hairstyle Changer are free once to use. You can upload your image, try on AI virtual hairstyles, and experiment with different colors without any cost and no sign-up needed.",
    },
    {
