...
export default function SelectStyle({
  ...
  return (
    <div className="w-full">
      ...
      <button
        onClick={() => fileInputRef.current?.click()}
        className="mb-6 w-full flex items-center justify-center gap-2 px-4 py-2 bg-white text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
      >
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
