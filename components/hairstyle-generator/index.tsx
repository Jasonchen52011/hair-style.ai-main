  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (response.status === 429) {
        toast.error('您已达到每日5次免费生成限制，请明天再试。', {
          duration: 5000,
          style: {
            background: '#1F2937',
            color: '#fff',
    ...
    <div className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="flex items-center justify-center mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
            currentStep === "select" ? "bg-purple-700 text-white" : "bg-gray-200 text-gray-400"
          }`}>
            2
          </div>
        </div>
        <div className="ml-4 text-sm text-gray-600">
          {currentStep === "upload" ? "上传照片" : "选择发型"}
        </div>
      </div>
      ...
      {currentStep === "upload" ? (
        ...
        <div className="text-center">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">AI 发型生成器</h2>
            <p className="text-gray-600">上传您的照片，让AI为您推荐最适合的发型</p>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-800">选择发型和颜色</h2>
            <button
          ...
          {/* 发型选择 */}
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-800 mb-3">选择发型</h3>
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 max-h-96 overflow-y-auto">
              {currentStyles.map((style) => (
                ...
                >
                  <div className="w-full h-20 mb-1 overflow-hidden rounded-xl">
                    <img
                      src={style.imageUrl}
                      alt={style.alt}
          ...
          {/* 颜色选择 */}
          <div className="mb-6">
            <h3 className="text-lg font-medium text-gray-800 mb-3">选择颜色</h3>
